...
$sql = "SELECT * FROM products WHERE category = 'machinery'";
            ...
            <div class="filters">
                ...
                <div class="product_grid">
                    ...
                    if (isset($_GET['sortby'])) {
                        $sortby = $_GET['sortby'];
                        if ($sortby == 'pricehilo') {
                            $sql = "SELECT * FROM products WHERE category = 'machinery' ORDER BY price DESC";
                        } elseif ($sortby = 'pricelohi') {
                            $sql = "SELECT * FROM products WHERE category = 'machinery' ORDER BY price ASC";
                        } 
                    } else {
                        $sql = "SELECT * FROM products WHERE category = 'machinery' ORDER BY in_stock DESC";
                    }
                    $result = mysqli_query($conn, $sql);
                    $resultCheck = mysqli_num_rows($result);
                    if ($resultCheck > 0) {    
