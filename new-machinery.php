...
$sql = "SELECT * FROM products WHERE category = 'new'";
            ...
            <div class="filters">
                ...
                <span class="price-filter">
                    <p><strong>Price:</strong>
                        <a href="machinery.php?sortby=pricelohi">Ascending</a> |
                        <a href="machinery.php?sortby=pricehilo">Descending</a>
                    </p>
                </span>              
                ...
                <div class="product_grid">
                    ...
                    if (isset($_GET['sortby'])) {
                        $sortby = $_GET['sortby'];
                        if ($sortby == 'pricehilo') {
                            $sql = "SELECT * FROM products WHERE category = 'new' ORDER BY price DESC";
                        } elseif ($sortby = 'pricelohi') {
                            $sql = "SELECT * FROM products WHERE category = 'new' ORDER BY price ASC";
                        } 
                    } else {
                        $sql = "SELECT * FROM products WHERE category = 'new' ORDER BY in_stock DESC";
                    }
                    $result = mysqli_query($conn, $sql);
                    $resultCheck = mysqli_num_rows($result);
                    if ($resultCheck > 0) {    
