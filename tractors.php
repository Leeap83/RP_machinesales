...
$sql = "SELECT * FROM products WHERE category = 'tractors'";
        ...
        <div class="product-section">
            ...
            <div class="filters">
                ...
                <span class="price-filter">
                    <p><strong>Price:</strong>
                        <a href="tractors.php?sortby=pricelohi">Ascending</a> |
                        <a href="tractors.php?sortby=pricehilo">Descending</a>
                    </p>
                </span>              
            ...
            <div class="product_grid">
                ...
                if (isset($_GET['sortby'])) {
                    $sortby = $_GET['sortby'];
                    if ($sortby == 'pricehilo') {
                        $sql = "SELECT * FROM products WHERE category = 'tractors' ORDER BY price DESC";
